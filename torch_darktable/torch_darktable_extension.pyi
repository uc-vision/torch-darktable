...
class Bilateral:
    def __init__(self, device: torch.device, width: int, height: int, sigma_s: float = ..., sigma_r: float = ..., detail: float = ...) -> None: ...
    def process(self, luminance: torch.Tensor) -> torch.Tensor: ...
    def process_denoise(self, luminance: torch.Tensor) -> torch.Tensor: ...
    sigma_s: float
    sigma_r: float
    detail: float

# Tone mapping functions
def compute_image_metrics(image: torch.Tensor, stride: int) -> torch.Tensor: ...
