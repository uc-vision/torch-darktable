...
class TonemapParams:
  def __init__(self, gamma: float, intensity: float, light_adapt: float, vibrance: float = 0.0) -> None: ...
  gamma: float
  intensity: float
  light_adapt: float
  vibrance: float
...
def aces_tonemap(image: torch.Tensor, params: TonemapParams) -> torch.Tensor: ...
def adaptive_aces_tonemap(image: torch.Tensor, metrics: torch.Tensor, params: TonemapParams) -> torch.Tensor: ...
...
def modify_vibrance(rgb_image: torch.Tensor, amount: float = ...) -> torch.Tensor: ...
