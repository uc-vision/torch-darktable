...
# Demosaicing classes
class PPG:
    def __init__(self, device: torch.device, width: int, height: int, pattern: BayerPattern, median_threshold: float = ...) -> None: ...
    def process(self, input: torch.Tensor) -> torch.Tensor: ...
    median_threshold: float

class RCD:
    def __init__(self, device: torch.device, width: int, height: int, pattern: BayerPattern, input_scale: float = ..., output_scale: float = ...) -> None: ...
    def process(self, input: torch.Tensor) -> torch.Tensor: ...
    input_scale: float
    output_scale: float

class PostProcess:
    def __init__(self, device: torch.device, width: int, height: int, pattern: BayerPattern, color_smoothing_passes: int = ..., green_eq_local: bool = ..., green_eq_global: bool = ..., green_eq_threshold: float = ...) -> None: ...
    def process(self, input: torch.Tensor) -> torch.Tensor: ...
...
# Wiener denoising
class Wiener:
    def __init__(self, device: torch.device, width: int, height: int, sigma: float = ..., eps: float = ..., overlap_factor: int = ...) -> None: ...
    def process(self, input: torch.Tensor) -> torch.Tensor: ...
    def process_advanced(self, input: torch.Tensor, noise_sigmas: torch.Tensor | None = ..., noise_scale: float = ...) -> torch.Tensor: ...
    sigma: float
    eps: float

# Wiener denoiser creation function
def create_wiener(device: torch.device, width: int, height: int, sigma: float = ..., eps: float = ..., overlap_factor: int = ...) -> Wiener: ...
