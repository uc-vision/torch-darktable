...
# Wiener denoising 
class Wiener:
    def __init__(self, device: torch.device, width: int, height: int, overlap_factor: int = ..., tile_size: int = ..., channels: int = ...) -> None: ...
...
def create_wiener(device: torch.device, width: int, height: int, overlap_factor: int = ..., tile_size: int = ..., channels: int = ...) -> Wiener: ...
