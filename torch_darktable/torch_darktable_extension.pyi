...
class TonemapParams:
  def __init__(self, gamma: float, intensity: float, light_adapt: float, color_adapt: float) -> None: ...
  gamma: float
  intensity: float
  light_adapt: float

# Tone mapping functions
def compute_image_metrics(images: list[torch.Tensor], stride: int = ..., min_gray: float = ...) -> torch.Tensor: ...
...
def bilinear5x5_demosaic(input: torch.Tensor, pattern: BayerPattern) -> torch.Tensor: ...
