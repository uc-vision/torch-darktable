...
# Demosaicing classes
class PPG:
    def __init__(self, device: torch.device, width: int, height: int, pattern: int, median_threshold: float = ...) -> None: ...
    def process(self, input: torch.Tensor) -> torch.Tensor: ...
    median_threshold: float

class RCD:
    def __init__(self, device: torch.device, width: int, height: int, pattern: int, input_scale: float = ..., output_scale: float = ...) -> None: ...
    def process(self, input: torch.Tensor) -> torch.Tensor: ...
    input_scale: float
    output_scale: float

class PostProcess:
    def __init__(self, device: torch.device, width: int, height: int, pattern: int, color_smoothing_passes: int = ..., green_eq_local: bool = ..., green_eq_global: bool = ..., green_eq_threshold: float = ...) -> None: ...
    def process(self, input: torch.Tensor) -> torch.Tensor: ...
...
def modify_saturation(rgb: torch.Tensor, saturation: float) -> torch.Tensor: ...
def modify_saturation_mult_add(rgb: torch.Tensor, saturation_mult: float, saturation_add: float) -> torch.Tensor: ...
...
def estimate_white_balance(bayer_images: list[torch.Tensor], pattern: BayerPattern, quantile: float = ..., stride: int = ...) -> torch.Tensor: ...

# Wiener denoising 
class Wiener:
    def __init__(self, device: torch.device, width: int, height: int, overlap_factor: int = ..., tile_size: int = ...) -> None: ...
...
def create_wiener(device: torch.device, width: int, height: int, overlap_factor: int = ..., tile_size: int = ...) -> Wiener: ...
