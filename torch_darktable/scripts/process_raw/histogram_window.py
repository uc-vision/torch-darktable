...
class HistogramWindow:
    ...
    def __init__(self, bayer_image, camera_settings, base_pipeline=None):
        ...
        self.fig.canvas.manager.set_window_title('Levels')
    ...
    @beartype
    def update_display(self, bayer_image, camera_settings, base_pipeline=None):
