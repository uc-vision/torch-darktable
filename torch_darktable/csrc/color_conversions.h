...
torch::Tensor modify_hsl(const torch::Tensor& rgb, float hue_adjust = 0.0f, float sat_adjust = 0.0f, float lum_adjust = 0.0f);
torch::Tensor modify_vibrance(const torch::Tensor& rgb, float amount = 0.0f);
